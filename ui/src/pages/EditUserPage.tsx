  ...
  const [state, formAction, isPending] = useActionState(
    async (_prevState: FormState, formData: FormData): Promise<FormState> => {
      ...
      if (!nameVal.trim()) {
        ...
        fieldErrors.name = 'Name must be 200 characters or less';
      }
      ...
      // Password is optional for updates, but if provided must be >= 6 chars
        ...
        <form action={formAction} className="bg-white shadow-md rounded-lg p-6 space-y-5">
          ...
          <div>
            ...
            <div className="flex justify-between mt-1">
              ...
              <p className="text-gray-500 text-xs ml-auto">{name.length}/200</p>
            </div>
          </div>
          ...
          <div>
            ...
            />
            <p className="text-gray-500 text-xs mt-1">Leave blank to keep unchanged</p>
